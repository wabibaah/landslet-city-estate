...
function EditListing() {
  ...
  // check if the one editing the property is the owner of the property
  useEffect(() => {
  ...
  async function onSubmit(e) {
    ...
    async function storeImage(image) {
      return new Promise((resolve, reject) => {
        ...
        console.log("we are in the storeImage function but not in the upload task");
        ...
        uploadTask.on(
          ...
          () => {
            ...
            getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
              console.log("upload task resolve");
              resolve(downloadURL);
            });
          }
        );
...
// set the longitude and latitude to make sure it is a number instead of a string
